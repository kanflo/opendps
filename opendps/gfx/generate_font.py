...
try:
    ...
    print("%s depends in the Python Image Library, please install:" % sys.argv[0])
...
def generate_size(size):
    ...
    font = ImageFont.truetype("Ubuntu-C.ttf", size)
    ...
    canvas.save("fonts/ubuntu_condensed_%s.png" % size)
    canvas_width.save("fonts/ubuntu_condensed_%d_width.png" % size)
