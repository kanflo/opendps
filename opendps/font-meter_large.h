...
#define FONT_METER_LARGE_MAX_GLYPH_HEIGHT (31)
#define FONT_METER_LARGE_MAX_GLYPH_WIDTH  (28)
#define FONT_METER_LARGE_MAX_DIGIT_WIDTH  (15)
...
extern const uint8_t font_meter_large_pixdata[1587];
